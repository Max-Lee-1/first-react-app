        ...
        >
            <div className="grid grid-cols-3 gap-4 mx-20">
                ...
                <div className="p-4 bg-gray-700 rounded-lg flex flex-col gap-1 col-span-2 row-span-1 drop-shadow-md">
                    ...
                    <p className="w-1/2 text-white text-xl text-justify p-4">
                        Hey, I get it, games are addictive. But remember, there's a whole
                        world out there beyond the virtual world. Don't let game addiction ruin your daily lives. Test yourself with these quizes to see if you are a game addict.
                    </p>
                </div>
                <div className="p-4 bg-gray-700 rounded-lg flex flex-col gap-1 col-span-2 row-span-1 drop-shadow-md">
                    <h1 class="text-white text-5xl font-bold drop-shadow-lg p-4">
                    ...
                    <p className="w-1/2 text-white text-xl text-justify p-4">
                        ...
                        and relationships will thank you for the balance. See if you have great management with your screen time here.
                    </p>
                </div>
