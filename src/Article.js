      ...
      <div class="media-scroller snap-mandatory snap-both grid gap-4 grid-flow-col overflow-x-auto overscroll-contain ml-20">
        ...
        <div class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            ...
            alt=""
          />
          <p class="title pl-4">Ut enim ad minim veniam</p>
        </div>
        <div class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="title pl-4">Duis aute irure dolor</p>
        </div>
        <div class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="title pl-4">Cillum dolore eu</p>
        </div>
        <div class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
        ...
        <div class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            ...
            alt=""
          />
          <p class="title pl-4">At lectus urnaVestibulum</p>
        </div>
        <div class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
