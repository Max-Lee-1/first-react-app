  ...
  return (
    ...
    >
      ...
      <div class="media-scroller snap-mandatory snap-both grid gap-4 grid-flow-col overflow-x-auto overscroll-contain ml-20">
        <button
          id="Article1"
          class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow"
        >
          <img
            ...
            alt=""
          />
          <p id class="text-left pl-4">
            Blog 1
          </p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Blog 2</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Blog 3</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Blog 4</p>
        </button>
      </div>
      ...
      <div class="media-scroller snap-mandatory snap-both grid gap-4 grid-flow-col overflow-x-auto overscroll-contain ml-20">
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            ...
            alt=""
          />
          <p class="text-left pl-4">Blog 5</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Ut enim ad minim veniam</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Duis aute irure dolor</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Cillum dolore eu</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
        ...
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            ...
            alt=""
          />
          <p class="text-left pl-4">At lectus urnaVestibulum</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-gray-700 rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-left pl-4">Vestibulum</p>
        </button>
      </div>
    </section>
  );
