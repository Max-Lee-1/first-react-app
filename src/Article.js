      ...
      <div class="media-scroller snap-mandatory snap-both grid gap-4 grid-flow-col overflow-x-auto overscroll-contain ml-20">
        ...
        >
          <img
            ...
            alt=""
          />
          <p class="text-white font-Arial text-left pl-4">Blog 1</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-Charcoal rounded-lg shadow">
          <img
            ...
            alt=""
          />
          <p class="text-white font-Arial text-left pl-4">Blog 2</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-Charcoal rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-white font-Arial text-left pl-4">Blog 3</p>
        </button>
        <button class="snap-start grid gap-4 pb-4 bg-Charcoal rounded-lg shadow">
          <img
            className="aspect-video object-cover"
            ...
            alt=""
          />
          <p class="text-white font-Arial text-left pl-4">Blog 4</p>
        </button>
      </div>
